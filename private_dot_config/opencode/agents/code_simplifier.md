...
hidden: true
temperature: 0.1
description: Refactor code for readability, lower complexity, better naming, and less duplication without changing behavior or public APIs. Use for cleanup/review of recent changes.
---
